...
abstract class $ItemCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String name, int price, String itemUrl, String? imageUrl});
}
...
class _$_Item with DiagnosticableTreeMixin implements _Item {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Item(id: $id, name: $name, price: $price, itemUrl: $itemUrl, imageUrl: $imageUrl)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, price, itemUrl, imageUrl);
